...
BOOST_AUTO_TEST_CASE(message_sign)
{
    ...
    const std::string expected_signature =
        "IHzVebMzlD0hfkEeNlfFcfZEmazmfO+F9WKoF3K+l1nNGuyWg03MjowQFk+QYTu326q7xP/Ju0K8SruNQz9jD5I=";
...
BOOST_AUTO_TEST_CASE(message_verify)
{
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "ARAX8pbi1ppudtyc6HYLrnUUrFPxGryrYD",
            "signature should be irrelevant",
            "message too"),
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "GcgWbwfv46miqvgVzSDtdzASevGmmhtTQC",
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "GN3MNNxvQfsrQyTE4ESQMFyoeARB8F6LWx",
