...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitcoingold: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a bitcoingold: URI or payment request"));
...
{
    QString strTitle = tr("Bitcoin Gold"); // default title
