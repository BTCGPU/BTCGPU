...
BOOST_AUTO_TEST_CASE(psbt_updater_test)
{
    ...
    bool complete = true;
    bool no_forkid = true;
    BOOST_REQUIRE_EQUAL(TransactionError::OK, m_wallet.FillPSBT(psbtx, complete, no_forkid, SIGHASH_ALL, false, true));
    ...
    BOOST_CHECK(spk_man->FillPSBT(psbtx, false, SIGHASH_ALL, true, true) != TransactionError::OK);
}
