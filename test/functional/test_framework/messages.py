...
def ToHex(obj, **kwargs):
    return bytes_to_hex_str(obj.serialize(**kwargs))
...
class CBlock(CBlockHeader):
    ...
    def serialize(self, with_witness=False, legacy=True):
        r = b""
        r += super(CBlock, self).serialize(legacy=legacy)
        if with_witness:
...
class msg_witness_block(msg_block):
    ...
    def serialize(self):
        r = self.block.serialize(with_witness=True, legacy=False)
        return r
