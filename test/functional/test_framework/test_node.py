...
class TestNode():
    ...
    def __init__(self, i, datadir, *, chain, rpchost, timewait, timeout_factor, bitcoind, bitcoin_cli, coverage_dir, cwd, extra_conf=None, extra_args=None, use_cli=False, start_perf=False, use_valgrind=False, version=None, descriptors=False):
        ...
        self.bitcoinconf = os.path.join(self.datadir, "bitcoingold.conf")
        ...
        # Configuration for logging is set as command-line args rather than in the bitcoingold.conf file.
...
class TestNodeCLI():
    ...
    def send_cli(self, command=None, *args, **kwargs):
        ...
        assert not (pos_args and named_args), "Cannot use positional arguments and named arguments in the same bgold-cli call"
        ...
        self.log.debug("Running bgold-cli {}".format(p_args[2:]))
