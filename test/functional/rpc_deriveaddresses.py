...
class DeriveaddressesTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        address = "btgrt1qjqmxmkpmxt80xz4y3746zgt0q3u3ferr57ryhh"
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, [1, 2]), ["btgrt1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqs7tkh8", "btgrt1qpgptk2gvshyl0s9lqshsmx932l9ccsv2ll4s8r"])
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, 2), [address, "btgrt1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqs7tkh8", "btgrt1qpgptk2gvshyl0s9lqshsmx932l9ccsv2ll4s8r"])
